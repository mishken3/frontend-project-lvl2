...
1. Импорт isObject из genDiff.js в stylish.js показывает ошибку линтера на цикличность импортов.
2. Формирование строки в stylish написан курица-лапой, нужно зарефакторить в конце проекта.
